        ...
        <div className={styles.mainContent}>
          ...
          <div className={styles.leftSection}>
            <h1 className={styles.heading}>
              ...
              <span className={styles.dotNetText}>Manual</span>
          ...
          <div className={styles.rightSection}>
            ...
            <div className={styles.card}>
              <p className={styles.cardText}>
                Become a Certified QA Professional<br />
                 with Our Manual Testing<br />
                Training Program
              </p>
        ...
        <div className={styles.newSectionContent}>
          ...
          <div className={styles.newLeftContent}>
            <div className={styles.badge}>
              <span>💻 Hello Software Testing Champs! 🚀</span>
            </div>
            ...
            <p className={styles.newDescription}>
             Start your QA journey with our Manual Testing Training Course, designed to provide a strong foundation in software testing principles, methodologies, and industry practices. This course covers the complete Software Development Life Cycle (SDLC) and Software Testing Life Cycle (STLC), test case design, defect tracking, and test execution. Perfect for beginners and non-programmers, it equips you with practical skills to perform functional, regression, integration, and usability testing across various applications—preparing you for real-world QA roles and interviews.
            </p>
      ...
      <div className={styles.learnSection}>
        <div className={styles.learnContent}>
          ...
          <div className={styles.learnRight}>
           ...
           Master Quality Assurance with Industry-Focused Manual Testing Training
            </p>
            ...
            <div className={styles.skillsGrid}>
              <div className={styles.skillsColumn}>
                <div className={styles.skillItem}>
                 ...
                 Understand core software testing concepts, roles, and responsibilities
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                 Learn SDLC, STLC, and different testing models (Waterfall, Agile)
                  </p>
                </div>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                  Design and document test plans, test cases, and test scenarios
              ...
              <div className={styles.skillsColumn}>
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
               Understand requirement traceability matrix (RTM) and test coverage
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                Execute manual testing on desktop, web, and mobile applications
                  </p>
                </div>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                  Learn industry-standard QA documentation and reporting techniques
                  </p>
                </div>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                 Build hands-on experience with real-time testing projects and interview prep
                  </p>
                </div>
              </div>
            </div>
