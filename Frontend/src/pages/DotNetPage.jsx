        ...
        <div className={styles.mainContent}>
          ...
          <div className={styles.leftSection}>
            <h1 className={styles.heading}>
              ...
              <span className={styles.dotNetText}>Dot Net</span>
        ...
        <div className={styles.newSectionContent}>
          ...
          <div className={styles.newLeftContent}>
            ...
            <p className={styles.newDescription}>
              ...
              designed to help you build secure, scalable, and high-performance applications using 
              C#, ASP.NET Core, Entity Framework, SQL Server, HTML, CSS, JavaScript, and Angular/React. 
              This hands-on program guides you through full-stack development, covering frontend design, 
              backend logic, API integration, database connectivity, and cloud deployment—perfect for 
              students, freshers, and professionals aiming for enterprise-level development roles.
            </p>
