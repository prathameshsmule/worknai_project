        ...
        <div className={styles.mainContent}>
          ...
          <div className={styles.leftSection}>
            <h1 className={styles.heading}>
              <span className={styles.becomeText}>SAP FICO</span>
          ...
          <div className={styles.rightSection}>
            ...
            <div className={styles.card}>
              <p className={styles.cardText}>
                Become a Finance and Controlling <br />
                Specialist with Our SAP FICO<br />
                Training Course
              </p>
      ...
      <div className={styles.newSection}>
        <div className={styles.newSectionContent}>
         ...
         SAP FICO Training
            ...
            Advance your career in enterprise finance with our SAP FICO Training Course, designed to provide comprehensive knowledge of Financial Accounting (FI) and Controlling (CO) modules in SAP. This hands-on program equips you with the skills to handle real-time financial transactions, manage reporting, perform cost control, and integrate finance with other SAP modules. Ideal for finance professionals, accountants, and ERP aspirants, this course helps you master SAP FICO processes and prepares you for industry roles and certification exams.
		 </p>
