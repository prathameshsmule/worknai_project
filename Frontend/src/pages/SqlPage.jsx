        ...
        <div className={styles.mainContent}>
          ...
          <div className={styles.leftSection}>
            <h1 className={styles.heading}>
              ...
              <span className={styles.dotNetText}>PL/SQL</span>
          ...
          <div className={styles.rightSection}>
            ...
            <div className={styles.card}>
              <p className={styles.cardText}>
                Become a Certified Oracle<br />
                 Developer with Our PL/SQL<br />
                 Training Course
              </p>
        ...
        <div className={styles.newSectionContent}>
          ...
          <div className={styles.newLeftContent}>
            ...
            <p className={styles.newDescription}>
             Boost your database development career with our PL/SQL Developer Training Course, designed to equip you with the skills to write, manage, and optimize PL/SQL programs in Oracle databases. This hands-on program covers procedures, functions, triggers, packages, cursors, and exception handling, along with performance tuning and real-time project execution. Whether you’re a student, developer, or aspiring database professional, this course prepares you to build robust database applications and work confidently in enterprise environments.
            </p>
        ...
        <div className={styles.learnContent}>
          ...
          <div className={styles.learnRight}>
            ...
            <p className={styles.learnSubtitle}>
             Master Oracle Programming with Industry-Ready PL/SQL Developer Training
            </p>
            ...
            <div className={styles.skillsGrid}>
              <div className={styles.skillsColumn}>
                <div className={styles.skillItem}>
                 ...
                 Understand PL/SQL architecture and Oracle database environment
                  </p>
                </div>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                   Write procedures, functions, and triggers to automate business logic
                  </p>
                </div>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                  Use cursors (implicit and explicit) to handle multi-row query results
                  </p>
                </div>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                 Create and manage packages for modular programming
                  </p>
                </div>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                   Handle exceptions and errors gracefully in PL/SQL blocks
              ...
              <div className={styles.skillsColumn}>
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                  Perform DML and DDL operations using PL/SQL scripts
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                   Optimize PL/SQL code for performance and efficiency
                  </p>
                </div>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                  Work with bulk operations, collections, and dynamic SQL
                  </p>
                </div>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                   Use TOAD/SQL Developer tools for real-time development and debugging
                  </p>
                </div>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                  Build real-world database applications and prepare for PL/SQL developer roles
                  </p>
                </div>
              </div>
            </div>
