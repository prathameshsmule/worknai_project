        ...
        <div className={styles.mainContent}>
          ...
          <div className={styles.leftSection}>
            <h1 className={styles.heading}>
              <span className={styles.becomeText}>DATA</span>
              <span className={styles.dotNetText}>Science</span>
            ...
            <div className={styles.card}>
              <p className={styles.cardText}>
                Become an Industry-Ready<br />
                 Data Scientist with Our Advanced<br />
        ...
        <div className={styles.newSectionContent}>
          ...
          <div className={styles.newLeftContent}>
            ...
            <p className={styles.newDescription}>
              Step into the world of AI and analytics with our Data Science Training Course, crafted to help you master the tools, techniques, and frameworks used by top data scientists. This hands-on program covers Python programming, machine learning, statistics, data visualization, and predictive modeling, using industry-standard tools like Pandas, Scikit-learn, Matplotlib, TensorFlow, and Power BI/Tableau. Whether you’re a fresher or working professional, this course equips you with real-world skills to solve business problems through data and prepares you for high-impact careers in data science.
            </p>
        ...
        <div className={styles.learnContent}>
          ...
          <div className={styles.learnRight}>
            ...
            <p className={styles.learnSubtitle}>
             Master AI, Analytics, and Machine Learning with Our Data Science Training
            </p>
            ...
            <div className={styles.skillsGrid}>
              <div className={styles.skillsColumn}>
                <div className={styles.skillItem}>
                 ...
                 Understand the data science lifecycle and analytical problem-solving
                  </p>
                </div>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                   Build predictive models using machine learning algorithms in Python
                  </p>
                </div>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                  Master exploratory data analysis (EDA) with Pandas and Matplotlib
                  </p>
                </div>
              ...
              <div className={styles.skillsColumn}>
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                 Work with tools like Jupyter Notebook, Scikit-learn, NumPy, and Seaborn
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                   Apply statistical techniques for real-world business applications
                  </p>
                </div>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                   Work on capstone projects to build a job-ready portfolio
                  </p>
                </div>
              </div>
            </div>
