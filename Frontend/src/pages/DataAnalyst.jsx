        ...
        <div className={styles.mainContent}>
          ...
          <div className={styles.leftSection}>
            <h1 className={styles.heading}>
              ...
              <span className={styles.developerText}>Analyst</span>
            </h1>
          ...
          <div className={styles.rightSection}>
            ...
            <div className={styles.card}>
              <p className={styles.cardText}>
                Become a Data-Driven Decision<br />
                Maker with Our Data Analyst<br />
                Training Course
              </p>
        ...
        <div className={styles.newSectionContent}>
          ...
          <div className={styles.newLeftContent}>
            ...
            <p className={styles.newDescription}>
              Launch your career in data with our Data Analyst Training Course, designed to provide you with the analytical, statistical, and technical skills needed to turn raw data into actionable insights. This hands-on program covers data visualization, data cleaning, SQL, Excel, Python, Tableau/Power BI, and real-world business analytics techniques. Ideal for students, freshers, and professionals, this course prepares you for in-demand roles in data analysis across industries by focusing on practical tools, industry projects, and job-ready skills.
            </p>
      ...
      <div className={styles.learnSection}>
        <div className={styles.learnContent}>
          ...
          <div className={styles.learnRight}>
            ...
            Transform Data into Insights with Industry-Focused Data Analyst Training
            </p>
            ...
            <div className={styles.skillsGrid}>
              <div className={styles.skillsColumn}>
                <div className={styles.skillItem}>
                 ...
                 Understand core concepts of data analysis and data lifecycle
                  </p>
                </div>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                   Perform data cleaning, wrangling, and transformation using Excel and Python
                  </p>
                </div>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                  Query and manipulate databases using SQL
                  </p>
                </div>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                  Visualize data with tools like Tableau and Power BI
                  </p>
                </div>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                   Apply descriptive and inferential statistics for business insights
                  </p>
                </div>
              </div>
              ...
              <div className={styles.skillsColumn}>
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                  Create dashboards and reports to communicate data findings
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                  Analyze trends and patterns using real-world datasets
                  </p>
                </div>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                 Work with libraries like Pandas, NumPy, and Matplotlib
                  </p>
                </div>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                  Use Google Sheets, Excel functions, and pivot tables effectively
                  </p>
                </div>
                ...
                <div className={styles.skillItem}>
                  <span className={styles.checkIcon}>✓</span>
                  <p className={styles.skillText}>
                  Gain practical experience with real-time data analysis projects
                  </p>
                </div>
              </div>
            </div>
